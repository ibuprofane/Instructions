...
internal class SnapshotViewController: DefaultViewController {
    ...
    func tutorialController(
        _ tutorialController: TutorialController,
        didShowCoachMarkWith configuration: CoachMarkConfiguration,
        after configurationChange: ConfigurationChange?,
        at index: Int
    ) {
        snapshotDelegate?.tutorialController(
    ...
    func tutorialController(
        _ tutorialController: TutorialController,
        willHideCoachMarkWith configuration: CoachMarkConfiguration,
        at index: Int
    ) {
        snapshotDelegate?.tutorialController(
            tutorialController,
    ...
    func tutorialController(
        _ tutorialController: TutorialController,
        didHideCoachMarkWith configuration: CoachMarkConfiguration,
        at index: Int
    ) {
        snapshotDelegate?.tutorialController(
            tutorialController,
