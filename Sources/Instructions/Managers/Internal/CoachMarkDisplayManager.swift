...
class CoachMarkDisplayManager {
    ...
    func createCoachMarkView(
        ...
        return CoachMarkView(
            ...
            pointerOffset: coachMark.marginBetweenContentAndPointer,
    ...
    private func prepare(
        ...
        usingCoachMark coachMark: CoachMarkConfiguration,
    ...
    private func generateAndEnableVerticalConstraints(
        ...
        let offset = coachMark.marginBetweenCoachMarkAndCutoutPath
    ...
    private func applyIdleAnimation(to coachMarkView: UIView, from coachMark: CoachMarkConfiguration,
                                    at index: Int) {
