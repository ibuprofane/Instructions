...
public extension CoachMarkHelper {
    @available(*, unavailable, renamed: "makeDefaultCoachViews(contentText:nextText:showPointer:position:)")
    ...
    @available(*, unavailable, renamed: "makeDefaultCoachViews(showNextLabel:showPointer:position:)")
    func makeDefaultCoachViews(
        withArrow arrow: Bool = true,
...
public extension CoachMarkConfiguration {
    ...
    @available(*, unavailable, renamed: "marginBetweenContentAndPointer")
    var gapBetweenBodyAndArrow: CGFloat {
        get { layout.marginBetweenContentAndPointer }
        set { }
    }

    @available(*, unavailable, renamed: "marginBetweenCoachMarkAndCutoutPath")
